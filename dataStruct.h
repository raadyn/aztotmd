...
struct Sim
{
   ...
   //functions for operating!
     //enery of i-j pair calculations (используетс€ дл€ обхода пар в функци€х cell_list или all_pair)
...
struct Atoms
{
   ...
   int *parents;    //! index of atom connected with this, однозначно определен только дл€ атомов с одной св€зью
...
struct Bond
{
  ...
  //int ind;              // current index (вспомогательна€ переменна€ дл€ вывода св€зей в файл)
...
struct Field
{
    ...
    double minRvdw;     // minimal distance of VdW interaction //! дл€ чего?
