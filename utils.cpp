...
//! тут хитрая конструкция, я её сам придумал, но не уверен, как она работает,похоже в i кладётся сравнение fscanf <= 0
//! поэтому если по окончанию цикал i = 1, т.е. тру, то цикл не нашёл того, что искал
