...
/*
 ...
 (
  ...
  "mulpd %%xmm0, %%xmm2\n\t"	//
  "mulpd %%xmm0, %%xmm3\n\t"	//
  "addpd %%xmm1, %%xmm4\n\t"	// ïåðåìíîæèòü ïàêåòû ïëàâàþùèõ òî÷åê: xmm4 = xmm4 * xmm1
  "addpd %%xmm2, %%xmm5\n\t"	// ïåðåìíîæèòü ïàêåòû ïëàâàþùèõ òî÷åê: xmm4 = xmm4 * xmm1
  "addpd %%xmm3, %%xmm6\n\t"	// ïåðåìíîæèòü ïàêåòû ïëàâàþùèõ òî÷åê: xmm4 = xmm4 * xmm1
  "movupd %%xmm4, %[vx]\n\t"	// âûãðóçèòü ðåçóëüòàòû èç ðåãèñòðà xmm
  "movupd %%xmm5, %[vy]\n\t"	// âûãðóçèòü ðåçóëüòàòû èç ðåãèñòðà xmm
  "movupd %%xmm6, %[vz]\n\t"	// âûãðóçèòü ðåçóëüòàòû èç ðåãèñòðà xmm
  "mulpd %%xmm4, %%xmm4\n\t"	//
  "mulpd %%xmm5, %%xmm5\n\t"	//
  "mulpd %%xmm6, %%xmm6\n\t"	//
  "addpd %%xmm5, %%xmm4\n\t"	// ïåðåìíîæèòü ïàêåòû ïëàâàþùèõ òî÷åê: xmm4 = xmm4 + xmm5
  "addpd %%xmm6, %%xmm4\n\t"	// ïåðåìíîæèòü ïàêåòû ïëàâàþùèõ òî÷åê: xmm4 = xmm4 + xmm6
  "mulpd %%xmm4, %%xmm7\n\t"	// v2 = v2 * m
  "movupd %%xmm4, %[m]\n\t"	// âûãðóçèòü ðåçóëüòàòû èç ðåãèñòðà xmm
  :
