...
struct Sim
{
   ...
   //functions for operating!
     //enery of i-j pair calculations (èñïîëüçóåòñÿ äëÿ îáõîäà ïàð â ôóíêöèÿõ cell_list èëè all_pair)
...
{
   int nAt;
   int* types;  //! çàìåíèòü íà Spec*
   double *xs, *ys, *zs;
   double *vxs, *vys, *vzs;
   double *fxs, *fys, *fzs;
   int *nBonds;  // the number of bonds (provided by bond_list)
   int *parents;    //! index of atom connected with this, îäíîçíà÷íî îïðåäåëåí òîëüêî äëÿ àòîìîâ ñ îäíîé ñâÿçüþ
...
struct Bond
{
  ...
  //int ind;              // current index (âñïîìîãàòåëüíàÿ ïåðåìåííàÿ äëÿ âûâîäà ñâÿçåé â ôàéë)
...
struct Field
{
    ...
    double minRvdw;     // minimal distance of VdW interaction //! äëÿ ÷åãî?
